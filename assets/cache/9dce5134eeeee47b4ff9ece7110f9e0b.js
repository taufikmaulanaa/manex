    ...
    function getSubaccount() {
        ...
        $.ajax({
                url : base_url + 'reporting/net_sales/get_subaccount',
	...
	function getSector() {
		$('#filter_sector').html('');
		$.ajax({
			url: base_url + 'reporting/net_sales/get_sector',
			data: {
    ...
    function getData() {
        ...
        var page = base_url + 'reporting/net_sales/data';
	...
	function save_perubahan() {
		...
		$.ajax({
			url: base_url + 'reporting/net_sales/save_perubahan',
			data: {
				'json': jsonString,
	...
	function download_template(){
		let tahun = $('#tahun').val();
		window.open(base_url + 'reporting/net_sales/template?tahun='+tahun)
	}
	...
	function do_import(){
		$.ajax({
			url: base_url + 'reporting/net_sales/import',
			data: {
				tahun: $('#tahun').val(),
	...
	function refresh_page() {
        $(document).on('click', '.swal-button--confirm', function(){
            setTimeout(function () {
                window.location.href = 'https://development.otsuka.co.id/manex/reporting/net_sales';
            }, 1000);
        })
    }
