...
foreach($mst_account[0] as $m0) { 
		...
		<td><b><?php echo $m0->account_code . '-' .$m0->account_name; ?></b></td>
			...
			if(!in_array($m0->id,$id_labour)) {
				...
				for ($i = 1; $i <= 12; $i++) { 
					...
					echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right budget '.$field0.'" data-name="'.$field0.'"  data-value="'.$x0.'">'.$x0.'</td>';
				}
			}else{
			...
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right total_budget" data-name="total_budget"  data-value="'.$xtotal0.'">'.$xtotal0.'</td>';
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right total_le" data-name="total_le"  data-value="'.$m0->total_le.'">'.$m0->total_le.'</td>';
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right increase" data-name="increase"  data-value="">%</td>';
	...
	foreach($mst_account[$m0->id] as $m1) { 
		...
		<tr>
				...
				foreach($total_labour as $v => $t){
					if($m1->id == $v) {
						...
						for ($i = 1; $i <= 12; $i++) { 
							...
							echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right budget '.$field1.'" data-name="'.$field1.'"  data-value="'.$x1.'">'.$x1.'</td>';
			...
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right total_le" data-name="total_le"  data-value="'.$m1->total_le.'">'.$m1->total_le.'</td>';
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right increase" data-name="increase"  data-value="">%</td>';
		...
		foreach($mst_account[$m1->id] as $m2) { 
				...
				foreach($total_labour as $v => $t){
					if($m2->id == $v) {
						...
						for ($i = 1; $i <= 12; $i++) { 
							...
							echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right budget '.$field2.'" data-name="'.$field2.'"  data-value="'.$x2.'">'.$x2.'</td>';
			...
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right total_le" data-name="total_le"  data-value="'.$m2->total_le.'">'.$m2->total_le.'</td>';
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right increase" data-name="increase"  data-value="">%</td>';
			...
			foreach($mst_account[$m2->id] as $m3) { 
				...
				<tr>
						...
						foreach($total_labour as $v => $t){
							if($m3->id == $v) {
								...
								for ($i = 1; $i <= 12; $i++) { 
									...
									echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right budget '.$field3.'" data-name="'.$field3.'"  data-value="'.$x3.'">'.$x3.'</td>';
					...
					echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right total_le" data-name="total_le"  data-value="'.$m3->total_le.'">'.$m3->total_le.'</td>';
					echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="'.$contentedit.'" contenteditable="true" class="edit-value text-right increase" data-name="increase"  data-value="">%</td>';
	...
	<tr>
		...
		foreach($total_header as $h => $th){
			...
			if($m0->id == $h) {
				...
				echo '<td class="text-right" bgcolor="#778899" style="color: white;"></td>';
				echo '<td class="text-right" bgcolor="#778899" style="color: white;">%</td>';
			}
		}
...
<?php } ?>
	...
	<tr>
		...
		echo '<td class="text-right" bgcolor="#D2691E" style="color: white;"><div style="background:" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="false" class="edit-value text-right"  data-id="" data-value=""></td>';
		echo '<td class="text-right" bgcolor="#D2691E" style="color: white;"><div style="background:" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="false" class="edit-value text-right"  data-id="" data-value="">%</td>';
