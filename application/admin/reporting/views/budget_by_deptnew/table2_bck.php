...
foreach($mst_account[0] as $m0) { 
		...
		<td><b><?php echo $m0->account_code . '-' .$m0->account_name; ?></b></td>
			...
			if(!in_array($m0->id,$id_labour)) {
				...
				for ($i = 1; $i <= 12; $i++) { 
					...
					$prsn = ($contentedit == 'true' ? '%' : '');

					$incr0 = ($contentedit == 'true' || $m0->total_budget !=0 ? ($m0->total_le / $m0->total_budget) * 100 : 0);
				...
				foreach($total_labour as $v => $t){
					if($m0->id == $v) {
						...
						for ($i = 1; $i <= 12; $i++) { 
							...
							$incr0 = ($contentedit == 'true' || $t['total'] !=0 ? ($t['total_le'] / $t['total']) * 100 : 0);
			...
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="false"  class="edit-value text-right increase" data-name="increase"  data-value=""> '.$incr0 . ' ' .$prsn.'</td>';
	...
	foreach($mst_account[$m0->id] as $m1) { 
		...
		<tr>
			...
			if(!in_array($m1->id,$id_labour)) {
				$x1 = 0;
					for ($i = 1; $i <= 12; $i++) { 
						...
						$xtotal11 = ($contentedit == 'true'  ? number_format($m1->total_le) : '');
						$prsn = ($contentedit == 'true' ? '%' : '');

						$incr1 = ($contentedit == 'true' && $m1->total_budget !=0 ? ($m1->total_le / $m1->total_budget) * 100 : 0);
				...
				foreach($total_labour as $v => $t){
					if($m1->id == $v) {
						...
						for ($i = 1; $i <= 12; $i++) { 
							...
							$incr1 = ($contentedit == 'true' || $t['total'] !=0 ? ($t['total_le'] / $t['total']) * 100 : 0);
			...
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="false"  class="edit-value text-right increase" data-name="increase"  data-value="">'.$incr1 . ' ' .$prsn.'</td>';
		...
		foreach($mst_account[$m1->id] as $m2) { 
			...
			if(!in_array($m2->id,$id_labour)) {
				...
				for ($i = 1; $i <= 12; $i++) { 
					...
					$xtotal22 = ($contentedit == 'true'  ? number_format($m2->total_le) : '');
					$prsn = ($contentedit == 'true' ? '%' : '');

					$incr2 = ($contentedit == 'true' && $m2->total_budget !=0 ? ($m2->total_le / $m2->total_budget) * 100 : 0);
				...
				foreach($total_labour as $v => $t){
					if($m2->id == $v) {
						...
						for ($i = 1; $i <= 12; $i++) { 
							...
							$prsn = ($contentedit == 'true' ? '%' : '');
							$incr2 = ($contentedit == 'true' || $t['total'] !=0 ? ($t['total_le'] / $t['total']) * 100 : 0);
			...
			echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="false"  class="edit-value text-right increase" data-name="increase"  data-value="">'.$incr2 . ' ' .$prsn.'</td>';
				...
				<tr>
					...
					if(!in_array($m3->id,$id_labour)) {
						...
						for ($i = 1; $i <= 12; $i++) { 
							...
							$xtotal33 = ($contentedit == 'true'  ? number_format($m3->total_le) : '');
							$prsn = ($contentedit == 'true' ? '%' : '');
							$incr2 = ($contentedit == 'true' || $m2->total_budget !=0 ? ($m2->total_le / $m2->total_budget) * 100 : 0);
						...
						foreach($total_labour as $v => $t){
							if($m3->id == $v) {
								...
								for ($i = 1; $i <= 12; $i++) {  
									...
									$prsn = ($contentedit == 'true' ? '%' : '');
									$incr3 = ($contentedit == 'true' || $t['total'] !=0 ? ($t['total_le'] / $t['total']) * 100 : 0);
					...
					echo '<td style="background: '.$bgedit.'"><div style="background:'.$bgedit.'" style="min-height: 10px; width: 50px; overflow: hidden;" contenteditable="false"  class="edit-value text-right increase" data-name="increase"  data-value="">'.$incr3 . ' ' .$prsn.'</td>';		
