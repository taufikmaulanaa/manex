    ...
    function getSubaccount() {
        ...
        $.ajax({
                url : base_url + 'reporting/cogs/get_subaccount',
	...
	function getSector() {
		$('#filter_sector').html('');
		$.ajax({
			url: base_url + 'reporting/cogs/get_sector',
			data: {
    ...
    function getData() {
        ...
        var page = base_url + 'reporting/cogs/data';
	...
	function save_perubahan() {
		...
		$.ajax({
			url: base_url + 'reporting/cogs/save_perubahan',
			data: {
				'json': jsonString,
	...
	function download_template(){
		let tahun = $('#tahun').val();
		window.open(base_url + 'reporting/cogs/template?tahun='+tahun)
	}
	...
	function do_import(){
		$.ajax({
			url: base_url + 'reporting/cogs/import',
			data: {
				tahun: $('#tahun').val(),
	...
	function refresh_page() {
        $(document).on('click', '.swal-button--confirm', function(){
            setTimeout(function () {
                window.location.href = 'https://development.otsuka.co.id/manex/reporting/cogs';
            }, 1000);
        })
    }
