...
<?php 
	modal_open('modal-form','','modal-lg');
		modal_body();
			form_open(base_url('material_cost/material_formula/save'),'post','form');
				col_init(3,9);
				input('hidden','id','id');
...
<script type="text/javascript">
	function getData() {
		...
		$.ajax({
			url 	: base_url + 'material_cost/material_formula/data',
			data 	: {},
			type	: 'get',
			dataType: 'json',
	...
	$('.btn-sort').click(function(){
		...
		$.ajax({
			url : base_url + 'material_cost/material_formula/data/sortable',
			type : 'get',
			dataType : 'json',
			success : function(response) {
	...
	$('#save-posisi').click(function(e){
		...
		$.ajax({
			url : base_url + 'material_cost/material_formula/save_sortable',
			type : 'post',
			data : serialized,
			dataType : 'json',
			success : function(response) {
